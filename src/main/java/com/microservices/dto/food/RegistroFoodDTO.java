...
public class RegistroFoodDTO {
	...
	public RegistroFoodDTO() {
		// TODO Auto-generated constructor stub
	}

	public RegistroFoodDTO(Double sugar_g, Double fiber_g, Double serving_size_g, Double sodium_mg, String name,
