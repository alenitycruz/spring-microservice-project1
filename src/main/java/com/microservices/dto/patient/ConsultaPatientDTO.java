...
public class ConsultaPatientDTO {
    ...
    public ConsultaPatientDTO() {
		// TODO Auto-generated constructor stub
	}

	public ConsultaPatientDTO(UUID id_patient, String name_patient, String birthday, String occupation_patient,
			String rg, String cpf, String telephone, String goal, Double height_patient, Double weight_patient,
			String allergy) {
		super();
