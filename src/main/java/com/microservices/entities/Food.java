...
public class Food implements Serializable {
	...
	public Food(UUID id_food, Double sugar_g, Double fiber_g, Double serving_size_g, Double sodium_mg, String name,
	...
	public Food seekForName(String name) {
		Food foodValues = new Food();
		name = foodValues.getName();
	...
	public String toString() {
		return "Food [id_food=" + id_food + ", sugar_g=" + sugar_g + ", fiber_g=" + fiber_g + ", serving_size_g="
				+ serving_size_g + ", sodium_mg=" + sodium_mg + ", name=" + name + ", potassium_mg=" + potassium_mg
				+ ", fat_saturated_g=" + fat_saturated_g + ", fat_total_g=" + fat_total_g + ", calories=" + calories
				+ ", cholesterol_mg=" + cholesterol_mg + ", protein_g=" + protein_g + ", carbohydrates_total_g="
